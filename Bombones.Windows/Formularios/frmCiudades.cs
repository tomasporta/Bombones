...
namespace Bombones.Windows
{
    ...
    public partial class frmCiudades : Form
    {
        ...
        public frmCiudades(IServiceProvider? serviceProvider)
        {
            ...
            _servicio = _serviceProvider?.GetService<IServiciosProveedores>()
        ...
        private void tsbNuevo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Ciudad? ciudad = frm.GetProveedor();
        ...
        private void tsbEditar_Click(object sender, EventArgs e)
        {
            ...
            if (ciudad is null) return;
            frmProveedoresAE frm = new frmProveedoresAE(_serviceProvider) { Text = "Editar Ciudad" };
            frm.SetCiudad(ciudad);
            DialogResult dr = frm.ShowDialog(this);
            if (dr == DialogResult.Cancel) return;
            ciudad = frm.GetProveedor();
